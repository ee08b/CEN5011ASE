...
<div id="sort1" class="groupWrapper">
	...
	<div id="news" class="groupItem">
		...
		<div class="itemContent">	
			<div id="header1" class="ui-sortable">              
    ...
    <div id="History" class="groupItem">
		...
		<div class="itemContent">
            <div id="header2" class="ui-sortable">
                <%String showLog = (String)session.getAttribute("showLog"); %> 
                <%=showLog %>
            </div>
		</div>
	</div>
...
<div id="sort2" class="groupWrapper">
	<div id="Material_Rserv" class="groupItem">
		...
		<div class="itemContent">
			<div id="header3" class="ui-sortable">
                <form action="/Library/AddMaterial" method="post">
	...
	<div id="Material" class="groupItem">
		...
		<div class="itemContent">
            <div id="header4" class="ui-sortable">
                <form action="/Library/AddMaterial" method="post">
                    ...
                    <input id="numbersignup" name="numbersignup" required="required" type="text" placeholder="number" />
